...
function Home() {
    ...
    // --- 여러개의 에러글 관리할 useState를 만들어도 되고, 하나의 useState를 사용할 수도 있음
    ...
    // 그 모양은 (data: 리액트훅폼에 맡겼던 그 타입) => {} 모양이 되어야 함
    ...
    */}
    ...
    return (
        <Wrap>
            <Card onSubmit={handleSubmit(onSubmit)}> {/* handleSubmit() => react-hook-form에 맡긴 validate를 진행 */}
                <Title>회원가입</Title>
                <InputGroup>
                    <Input
                        placeholder={"아이디"}
